...
@Component({
  selector: 'app-quotation-basic',
  templateUrl: './quotation-basic.component.html',
  styleUrls: ['./quotation-basic.component.css']
})
export class QuotationBasicComponent implements OnInit {
  ...
  public updateQuotationMain() {
    ...
    console.log('product codeeee   ' + this.ProductCode);
  ...
  private validateFields() {
    ...
    console.log('aaaaaaaa this.ProductCode ' + this.ProductCode);
