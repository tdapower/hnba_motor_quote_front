...
@Component({
  selector: 'app-quotation-takaful-search',
  templateUrl: './quotation-takaful-search.component.html',
  styleUrls: ['./quotation-takaful-search.component.css']
})
export class QuotationTakafulSearchComponent implements OnInit {
  ...
  constructor(private quotationTakafulService: QuotationTakafulService, 
  ...
  search() {
    ...
    this.quotationTakafulService.searchQuotationDetails(objSearchQuotations).subscribe((data: any) => {
      console.log(data);
  ...
  setClickedRow = function (index, JobId) {
    ...
    this.router.navigate(['/', 'viewTakaful', JobId]);
  }
