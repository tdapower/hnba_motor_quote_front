...
@Component({
  ...
  templateUrl: './quotation-takaful-add.component.html',
  styleUrls: ['./quotation-takaful-add.component.css']
})
export class QuotationTakafulAddComponent implements OnInit {
    ...
    for (var i = 1; i < 40; i++) {
      ...
      if (eval(chkName)) {
        ...
        if (chkString == "chk2" || chkString == "chk4" || chkString == "chk5" || chkString == "chk6" || chkString == "chk7" || chkString == "chk9" || chkString == "chk10" || chkString == "chk12" || chkString == "chk13") {
          ...
          if (chkString == "chk10") {
            console.log('validation for up ncb =' + this.upFrontNCBId);
